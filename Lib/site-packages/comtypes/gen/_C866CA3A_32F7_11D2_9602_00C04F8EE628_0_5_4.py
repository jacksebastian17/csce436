...
__all__ = [
    'SVP_3', 'DISPID_SVPause', 'SPSModifier', 'SAFT32kHz8BitMono',
    'DISPID_SPRDisplayAttributes', 'DISPID_SVAudioOutput',
    'DISPID_SPRsCount', 'SREAudioLevel', 'DISPID_SRGCommit',
    'DISPID_SpeechPhraseElement', 'DISPID_SpeechObjectTokens',
    'DISPID_SPIRule', 'ISpLexicon', 'SAFTGSM610_22kHzMono',
    'SP_VISEME_8', 'DISPID_SpeechVoiceEvent', 'DISPID_SVSpeak',
    'SPINTERFERENCE_TOOFAST', 'SPEI_PHONEME', 'DISPID_SLPs_NewEnum',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SGRSTsItem', 'SDTRule',
    'STCRemoteServer', 'SPSHT_NotOverriden', 'SPVPRI_NORMAL',
    'DISPID_SWFESamplesPerSec', 'SVP_18', 'ISpeechPhraseProperties',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SpeechAudioFormat',
    'SPFM_CREATE', 'DISPID_SPPId', 'eLEXTYPE_PRIVATE1', 'SPLO_STATIC',
    'DISPID_SRSetPropertyString', 'STSF_LocalAppData', 'SWTDeleted',
    ...
    'SpeechRecognizerState', 'DISPID_SPPName', 'IEnumSpObjectTokens',
    'SDTReplacement', 'SASStop', 'SAFTADPCM_8kHzStereo',
    'ISpeechPhraseElement', 'DISPID_SRGState',
    'DISPID_SOTGetAttribute', 'SAFTCCITT_uLaw_8kHzMono',
    'SpStreamFormatConverter', 'eLEXTYPE_LETTERTOSOUND',
    'SDA_One_Trailing_Space', 'SAFTGSM610_44kHzMono',
    'DISPID_SRGCmdLoadFromMemory', 'ISpeechDataKey',
    'DISPID_SWFEBlockAlign', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SWFEChannels', 'DISPID_SRStatus', 'UINT_PTR', 'SVP_0',
    'SPWF_INPUT', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SASNonBlockingIO', 'SAFT8kHz8BitMono',
    'DISPID_SWFEBitsPerSample', 'DISPID_SPEPronunciation',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SPERequiredConfidence',
    'SECFIgnoreCase', 'SAFT8kHz16BitStereo', 'SPPS_SuppressWord',
    'SAFTDefault', 'SAFTCCITT_uLaw_22kHzStereo', 'eLEXTYPE_PRIVATE8',
    'SP_VISEME_17', 'SPAR_Low', 'SDTDisplayText',
    'DISPID_SRGCmdLoadFromFile', 'ISpeechAudio', 'eLEXTYPE_PRIVATE5',
    'SpeechRecognitionType', 'SpPhoneticAlphabetConverter',
    'SpeechLoadOption', 'SAFTCCITT_uLaw_22kHzMono',
    'SpeechPropertyResponseSpeed', 'SpMemoryStream',
    'SPADAPTATIONRELEVANCE', 'SPSLMA', 'DISPID_SVEStreamEnd',
    'SPAS_CLOSED', 'SGSEnabled', 'SGRSTTWord', 'SP_VISEME_11',
    'DISPID_SRCEFalseRecognition', 'ISpeechPhraseReplacements',
    'DISPID_SLPsCount', 'SpPhraseInfoBuilder', 'SPGRAMMARSTATE',
    'SAFT22kHz16BitMono', 'SpeechAudioVolume', 'DISPID_SRCRecognizer',
    'SpShortcut', 'SAFTCCITT_ALaw_22kHzMono', 'SRTExtendableParse',
    'DISPID_SPIAudioSizeTime', 'SpFileStream', 'SAFTGSM610_11kHzMono',
    'DISPID_SPEsItem', 'STCInprocServer', 'SASClosed', 'STSF_AppData',
    'SPSNoun', 'SpeechDataKeyLocation', 'DISPID_SpeechLexiconProns',
    'SVP_11', 'SAFT16kHz16BitStereo',
    'DISPID_SPANumberOfElementsInResult', 'SP_VISEME_16',
    'ISpRecoCategory', 'DISPID_SAFGetWaveFormatEx', 'SVSFIsNotXML',
    'SPRST_INACTIVE', 'SPRECOSTATE', 'ISpeechObjectToken',
    ...
    'SPWORDPRONOUNCEABLE', 'ISpeechCustomStream', 'SVSFDefault',
    'DISPID_SRIsShared', 'SpeechRuleAttributes',
    'SAFTADPCM_22kHzStereo', 'SpeechVoiceSpeakFlags',
    'ISpeechLexicon', 'ISpRecoContext', 'DISPID_SASFreeBufferSpace',
    'ISpeechGrammarRules', 'DISPID_SPCPhoneToId', 'SPGS_ENABLED',
    'SPTEXTSELECTIONINFO', 'SVSFPurgeBeforeSpeak', 'SGPronounciation',
    'ISpeechGrammarRuleStateTransition', 'DISPIDSPTSI',
    'ISpeechRecoResult2', 'SpeechRecoEvents', 'DISPID_SPIElements',
    'SpeechStreamSeekPositionType', 'SP_VISEME_0',
    'DISPID_SPRulesCount', 'SDTAlternates', 'SRATopLevel',
    'SRTSMLTimeout', 'DISPID_SPRulesItem', 'DISPID_SVGetAudioInputs',
    'ISpeechPhraseProperty', 'eLEXTYPE_RESERVED9',
    'DISPID_SRGetFormat', 'DISPID_SpeechPhraseProperties',
    'SpeechAudioState', 'DISPID_SPIAudioSizeBytes', 'SVP_17',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'ISpeechPhraseRules',
    'SRTAutopause', 'SFTInput', 'DISPID_SVDisplayUI', 'SVPNormal',
    'SPPS_Noncontent', 'SREHypothesis', 'SPCT_SUB_DICTATION',
    'SAFTADPCM_44kHzStereo', 'SP_VISEME_5',
    'DISPID_SRGSetTextSelection', 'DISPID_SGRs_NewEnum', 'SpStream',
    ...
    'SPEI_RESERVED3', 'eLEXTYPE_PRIVATE11', 'DISPID_SRCState',
    'IInternetSecurityManager', 'DISPID_SPPsItem',
    'SPINTERFERENCE_NONE', 'DISPID_SRGId', 'eLEXTYPE_PRIVATE18',
    'DISPID_SVSInputWordPosition', 'DISPID_SPEActualConfidence',
    'SVP_5', 'DISPID_SRGetRecognizers',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SpeechAudio',
    'SRAONone', 'DISPID_SPCLangId', 'DISPID_SPRNumberOfElements',
    'SPLO_DYNAMIC', 'DISPID_SFSOpen', 'DISPID_SRGCmdSetRuleIdState',
    'SVSFIsXML', 'DISPID_SDKGetlongValue', 'DISPID_SGRName',
    'SWPKnownWordPronounceable', 'SVP_9', 'DISPID_SGRSTPropertyName',
    'tagSTATSTG', 'SPPS_Unknown', 'DISPID_SGRsItem',
    'SAFT8kHz16BitMono', 'SWPUnknownWordPronounceable',
    'DISPID_SRSCurrentStreamPosition', 'SAFT12kHz8BitMono',
    'ISpeechPhraseAlternates', 'ISpNotifySource',
    'DISPID_SPCIdToPhone', 'DISPID_SpeechPhraseAlternates',
    'SPAO_RETAIN_AUDIO', 'SpeechPartOfSpeech', 'SAFT16kHz16BitMono',
    'SVPOver', 'DISPID_SMSADeviceId', 'DISPID_SREmulateRecognition',
    'DISPID_SRCVoicePurgeEvent', 'SVF_None', 'DISPID_SRCEHypothesis',
    'SAFT24kHz8BitMono', 'SPPHRASEELEMENT', 'eLEXTYPE_PRIVATE9',
    'SDTLexicalForm', 'SPSHT_Unknown', '__MIDL_IWinTypes_0009',
    'DISPID_SRCERecognizerStateChange', 'SLODynamic',
    'ISpeechAudioBufferInfo', 'DISPID_SDKSetStringValue',
    'DISPID_SRGReset', 'SpLexicon', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SpeechAudioStatus', 'DISPID_SGRSAddRuleTransition',
    'Speech_StreamPos_Asap', 'SINoise', 'SP_VISEME_18',
    'SDTPronunciation', 'eLEXTYPE_PRIVATE13',
    'DISPID_SAFSetWaveFormatEx', 'SPSUnknown', 'SFTSREngine',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SBSWrite',
    'ISpeechLexiconWords', 'DISPID_SVEVoiceChange', 'SRCS_Disabled',
    'DISPID_SVSpeakCompleteEvent', 'SpeechRetainedAudioOptions',
    'ISequentialStream', 'DISPID_SRGDictationUnload', 'SP_VISEME_6',
    'SPEI_MAX_SR', 'DISPID_SRState', 'SpeechTokenKeyFiles',
    'DISPID_SRCERecognition', 'SDTAll', 'DISPID_SRCEAudioLevel',
    'SPAUDIOOPTIONS', 'DISPID_SpeechCustomStream',
    'SAFT32kHz16BitStereo', 'ISpeechLexiconWord',
    'DISPID_SPIEngineId', 'SVP_2', 'eLEXTYPE_PRIVATE10',
    'eLEXTYPE_PRIVATE19', 'DISPID_SRCEPropertyNumberChange',
    'SPAS_STOP', 'SPPHRASERULE', 'DISPID_SRGCmdSetRuleState',
    'ISpeechPhoneConverter', 'SpeechDictationTopicSpelling',
    'DISPID_SABIEventBias', 'DISPID_SVSLastResult', 'ISpeechVoice',
    'DISPID_SPRuleEngineConfidence', 'SPEI_REQUEST_UI', 'SVP_7',
    'SPSFunction', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    ...
    'DISPID_SGRInitialState', 'SpeechWordType', 'SRSInactive',
    'DISPID_SASCurrentDevicePosition', 'eLEXTYPE_PRIVATE14',
    'SpeechUserTraining', 'SWPUnknownWordUnpronounceable',
    'SPEI_PROPERTY_STRING_CHANGE', 'STCAll', 'SPSERIALIZEDPHRASE',
    ...
    'eLEXTYPE_RESERVED6', 'SRTStandard', 'SPEI_TTS_AUDIO_LEVEL',
    'SPSEMANTICFORMAT', 'ISpMMSysAudio', 'ISpeechBaseStream',
    'DISPID_SGRsCommitAndSave', 'SPSHT_OTHER',
    'SPINTERFERENCE_NOSIGNAL', 'ISpeechRecoResult',
    'ISpeechGrammarRule', 'Speech_StreamPos_RealTime',
    'DISPID_SVSLastBookmarkId', 'SPWORDLIST', 'SPPROPERTYINFO',
    'SDKLCurrentConfig', 'SAFT11kHz8BitStereo',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SBSFormat',
    'SAFTCCITT_ALaw_44kHzMono', 'ISpRecoResult',
    'SPSEMANTICERRORINFO', 'SPCT_DICTATION',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SVRate', 'SPEI_RESERVED6',
    'STSF_FlagCreate', 'SpeechRecoContextState', 'DISPID_SMSSetData',
    'ISpPhoneConverter', 'DISPID_SLWsCount', 'SVSFParseAutodetect',
    'ISpeechVoiceStatus', 'SECFNoSpecialChars', 'DISPID_SVEBookmark',
    'SVSFParseMask', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SPRuleParent', 'DISPID_SLWType', 'SVP_13',
    'DISPID_SPPEngineConfidence', 'DISPID_SPISaveToMemory',
    'SPSHT_EMAIL', 'ISpeechRecognizerStatus', 'ISpRecognizer',
    'DISPID_SRDisplayUI', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SpeechGrammarRuleState', 'SPFM_OPEN_READONLY',
    'SVSFNLPSpeakPunc', 'SSTTWildcard', 'SLTUser', 'SGRSTTDictation',
    'DISPID_SPIGrammarId', 'SPEI_FALSE_RECOGNITION',
    'eLEXTYPE_PRIVATE4', 'DISPID_SRCESoundEnd', 'DISPID_SVSPhonemeId',
    'SPEVENT', 'SPEVENTENUM', 'ISpeechRecognizer',
    'SAFT48kHz16BitMono', 'DISPID_SpeechVoiceStatus',
    'DISPID_SGRsFindRule', 'SpNotifyTranslator',
    'SVESentenceBoundary', 'DISPID_SAFGuid', 'SVSFPersistXML',
    ...
    'SPINTERFERENCE_NOISE', 'SAFT22kHz16BitStereo', 'SVSFIsFilename',
    'ISpeechLexiconPronunciations', 'SPSVerb', 'SpeechMicTraining',
    'SpeechVoiceSkipTypeSentence', 'SPEI_TTS_PRIVATE',
    'ISpeechAudioStatus', 'SAFT11kHz16BitStereo', 'SVEPhoneme',
    'DISPID_SVStatus', 'SGSExclusive', 'SGRSTTEpsilon', 'SAFTText',
    'SPSInterjection', 'LONG_PTR', 'DISPID_SpeechWaveFormatEx',
    'SPEI_INTERFERENCE', 'SpCustomStream', 'SDKLDefaultLocation',
    'SpeechVoiceCategoryTTSRate', 'ISpeechXMLRecoResult',
    'SPPS_RESERVED4', 'SPEI_RECO_STATE_CHANGE', 'SBOPause',
    ...
    'SPCT_SUB_COMMAND', 'DISPID_SLRemovePronunciation', 'SGSDisabled',
    'DISPID_SLGetGenerationChange', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SRIsUISupported', 'eLEXTYPE_PRIVATE15',
    'DISPID_SRCResume', 'SpeechCategoryAudioIn',
    'DISPID_SpeechBaseStream', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SPRuleChildren', 'DISPID_SRCreateRecoContext',
    'ISpeechPhraseElements', 'SSFMOpenForRead', 'SP_VISEME_21',
    'ISpGrammarBuilder', 'ISpPhraseAlt', 'ISpeechMMSysAudio',
    'ISpeechRecoResultDispatch', 'ISpeechGrammarRuleState',
    'ISpVoice', 'SpeechGrammarWordType',
    'DISPID_SPIAudioStreamPosition', 'SP_VISEME_7',
    ...
    'DISPID_SBSSeek', 'DISPID_SGRsAdd', 'DISPID_SPEDisplayAttributes',
    'SpeechTokenKeyUI', 'DISPID_SpeechPhraseElements', 'SPFILEMODE',
    'DISPID_SVEViseme', 'SPEI_SR_BOOKMARK', 'ISpStreamFormat',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SpeechLexiconWords',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SVESentenceBoundary',
    'SRSActive', 'SITooFast', 'DISPID_SLWWord',
    'DISPID_SOTMatchesAttributes', 'SVEStartInputStream',
    'SPEI_MAX_TTS', 'SPEI_HYPOTHESIS', 'DISPID_SGRAttributes',
    'DISPID_SVVolume', 'SRSEIsSpeaking', 'SPEI_END_SR_STREAM',
    'SPEI_END_INPUT_STREAM', 'SPWT_PRONUNCIATION',
    'DISPID_SRSAudioStatus', 'SpeechGrammarTagDictation', 'SVP_20',
    'DISPID_SRCEPhraseStart', 'DISPID_SCSBaseStream', 'SpMMAudioOut',
    'ISpeechGrammarRuleStateTransitions', 'SPEI_RESERVED1',
    'SVEEndInputStream', 'SPSMF_SAPI_PROPERTIES',
    'SpeechBookmarkOptions', 'DISPID_SRRAudio', 'SSFMCreate',
    'SRESoundEnd', 'SDA_No_Trailing_Space', 'SVP_6',
    'DISPID_SVSInputSentencePosition', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SpeechDataKey', 'SAFTADPCM_22kHzMono',
    'SSFMCreateForWrite', 'DISPID_SVAlertBoundary',
    'SPGRAMMARWORDTYPE', 'DISPID_SDKEnumValues', 'SDKLLocalMachine',
    'DISPID_SGRSTType', 'DISPID_SRCEventInterests', 'SPEI_UNDEFINED',
    'SAFT44kHz8BitStereo', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRCERecognitionForOtherContext', 'ISpEventSource',
    'SPCS_DISABLED', 'SpObjectTokenCategory', 'ISpeechResourceLoader',
    'DISPID_SRGDictationLoad', 'SPBINARYGRAMMAR',
    'SpeechVisemeFeature', 'ISpShortcut',
    'ISpPhoneticAlphabetSelection', 'DISPID_SVSInputWordLength',
    'SECLowConfidence', 'SGLexicalNoSpecialChars', 'SPBO_NONE',
    'SVF_Stressed', 'SPVISEMES', 'SPRS_ACTIVE_USER_DELIMITED',
    'SGDSActive', 'DISPID_SGRAddResource',
    'SpeechPropertyResourceUsage', 'DISPID_SRGetPropertyString',
    'DISPID_SPELexicalForm', 'DISPID_SLWs_NewEnum',
    'DISPID_SRRPhraseInfo', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SVEventInterests', 'SPAUDIOBUFFERINFO',
    'DISPID_SPAs_NewEnum', 'SREAdaptation',
    ...
    'ISpeechRecoContext', 'DISPID_SRRGetXMLErrorInfo', 'SpVoice',
    'SPRST_ACTIVE_ALWAYS', 'eLEXTYPE_PRIVATE17',
    'SAFTGSM610_8kHzMono', 'DISPID_SpeechPhraseProperty',
    'DISPID_SLPPhoneIds', 'DISPID_SPEAudioSizeTime', 'SPCT_SLEEP',
    'SAFT44kHz16BitStereo', 'ISpNotifyTranslator', 'SP_VISEME_14',
    'STCInprocHandler', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SLWsItem', 'DISPID_SRCEEnginePrivate',
    'SAFTCCITT_ALaw_11kHzMono', 'SPPHRASEPROPERTY',
    'DISPID_SMSAMMHandle', 'SAFTADPCM_44kHzMono', 'SP_VISEME_19',
    'SPXRO_SML', 'DISPID_SPIRetainedSizeBytes', 'DISPID_SGRSTRule',
    'DISPID_SDKCreateKey', 'SAFT32kHz16BitMono', 'DISPID_SVPriority',
    'eLEXTYPE_PRIVATE6', 'eLEXTYPE_APP', 'SITooQuiet',
    'eLEXTYPE_RESERVED8', 'SVEAudioLevel', 'SECHighConfidence',
    'DISPID_SGRSTText', 'DISPID_SpeechRecoResult',
    'DISPID_SPEDisplayText', 'SPWF_SRENGINE',
    'SpeechSpecialTransitionType', 'SpeechAudioFormatGUIDText',
    'DISPID_SRSClsidEngine', 'DISPID_SLPLangId',
    'SPEI_SR_AUDIO_LEVEL', 'SPWORDPRONUNCIATION',
    'SPRECOCONTEXTSTATUS', 'DISPID_SRRecognizer', 'DISPID_SRRTLength',
    'SRCS_Enabled', 'SPEI_VISEME', 'DISPID_SRSSupportedLanguages',
    'SpeechRecoProfileProperties', 'DISPID_SGRsCount',
    'SpeechTokenShellFolder', 'ISpeechPhraseInfoBuilder',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SAFT48kHz8BitMono',
    'DISPID_SRCEEndStream', 'DISPID_SRSCurrentStreamNumber', 'SASRun',
    'SAFT12kHz16BitStereo', 'SpeechEmulationCompareFlags',
    'SPFM_CREATE_ALWAYS', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SPEI_ADAPTATION', 'SPPS_Verb', 'DISPID_SOTDataKey',
    'SECFIgnoreKanaType', 'SVSFParseSsml',
    'DISPID_SpeechPhoneConverter', 'DISPID_SGRsCommit',
    'SVSFlagsAsync', 'DISPID_SpeechRecognizer', 'SpObjectToken',
    'DISPID_SRGDictationSetState', 'DISPID_SRAudioInputStream',
    'DISPID_SPRuleName', 'SAFTExtendedAudioFormat', 'DISPID_SRRTimes',
    'DISPID_SPRs_NewEnum', 'SPRECOGNIZERSTATUS',
    'SAFT48kHz8BitStereo', 'DISPID_SRRSetTextFeedback', 'SVEBookmark',
    'SPDKL_CurrentUser', 'DISPID_SLPsItem', 'DISPID_SPRText',
    'DISPID_SDKOpenKey', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SGRSRule',
    'DISPID_SVEStreamStart', 'SVPAlert', 'SPPS_RESERVED3',
    'SDA_Two_Trailing_Spaces', 'SpeechTokenContext', '_SPAUDIOSTATE',
    'eLEXTYPE_PRIVATE7', 'ISpNotifySink',
    'DISPID_SLAddPronunciationByPhoneIds', 'ISpEventSink',
    'SECFIgnoreWidth', 'SREFalseRecognition', 'eWORDTYPE_DELETED',
    'SpeechCategoryRecoProfiles', 'DISPIDSPRG',
    'SpeechGrammarTagWildcard', 'DISPID_SPRuleNumberOfElements',
    'SPPS_RESERVED1', 'DISPID_SVIsUISupported', 'SPEI_RESERVED2',
    'SPBO_TIME_UNITS', 'DISPID_SRCAudioInInterferenceStatus',
    'SLTApp', 'SPINTERFERENCE_TOOSLOW', 'DISPID_SPPsCount',
    'DISPID_SOTCId', 'SP_VISEME_12', 'DISPID_SRAudioInput',
    'SRERecognition', 'SPEI_START_INPUT_STREAM', 'DISPID_SPAsItem',
    'SPSNotOverriden', 'SPEI_SOUND_END', 'DISPID_SABIMinNotification',
    'DISPID_SVEEnginePrivate', 'DISPID_SPIReplacements',
    'DISPID_SVSVisemeId', 'SPRST_ACTIVE', 'DISPID_SOTCSetId',
    'DISPID_SpeechRecoContextEvents', 'SPCT_COMMAND',
    'SpeechTokenIdUserLexicon', 'SP_VISEME_1', 'SPRS_ACTIVE',
    'DISPID_SPAsCount', 'DISPID_SPEsCount',
    'DISPID_SOTGetStorageFileName', 'SpTextSelectionInformation',
    'SRTEmulated', 'DISPID_SPPNumberOfElements',
    'DISPID_SpeechLexicon', 'SRESoundStart', 'SREInterference',
    'SPRST_NUM_STATES', 'ISpXMLRecoResult', 'DISPID_SPPs_NewEnum',
    'DISPID_SOTDisplayUI', 'SPRECORESULTTIMES',
    'Speech_Max_Pron_Length', 'SPPS_RESERVED2', 'SPEI_SR_PRIVATE',
    'SPSTREAMFORMATTYPE', 'DISPID_SVEWord', 'SVP_1', 'SPRS_INACTIVE',
    ...
    'eLEXTYPE_PRIVATE12', 'SP_VISEME_10', 'SINone',
    ...
    'DISPIDSPTSI_SelectionOffset', 'SDTAudio', 'SpeechDiscardType',
    'SSTTDictation', 'SpPhoneConverter', 'ISpeechRecoGrammar',
    ...
    'SRAInterpreter', 'SPEI_START_SR_STREAM', 'SPAUDIOSTATUS',
    'eLEXTYPE_MORPHOLOGY', 'SVP_15', 'DISPID_SPAPhraseInfo',
    'SPEVENTSOURCEINFO', 'DISPID_SpeechMMSysAudio', 'DISPID_SBSRead',
    'DISPID_SRRTStreamTime', 'DISPID_SpeechPhraseRule',
    'DISPID_SpeechGrammarRule', 'SPEI_MIN_SR', 'DISPID_SPRuleId',
    'DISPID_SOTRemoveStorageFileName', 'SPEI_TTS_BOOKMARK',
    'SpeechCategoryVoices', 'SDKLCurrentUser',
    'SAFTCCITT_ALaw_8kHzMono', 'SVSFNLPMask', 'SVP_8',
    'Speech_Default_Weight', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SPXMLRESULTOPTIONS', 'SpeechRegistryUserRoot',
    'DISPID_SRGRecoContext', 'SPWT_DISPLAY', 'ISpeechPhraseRule',
    'SAFT22kHz8BitMono', 'DISPID_SPIGetText', 'DISPID_SLGetWords',
    'SPVPRIORITY', 'DISPID_SDKDeleteKey', 'SRADynamic',
    'SPLOADOPTIONS', 'SPAS_PAUSE', 'DISPID_SGRClear', 'SpAudioFormat',
    'SP_VISEME_15', 'SPSHORTCUTTYPE',
    'SpeechPropertyComplexResponseSpeed', 'SPEI_RESERVED5',
    'SPDKL_LocalMachine', 'SRADefaultToActive', 'eLEXTYPE_PRIVATE20',
    'SPSHORTCUTPAIRLIST', 'DISPID_SRRAudioFormat',
    'SAFT32kHz8BitStereo', '_RemotableHandle', 'ISpObjectWithToken',
    'SREBookmark', 'SPDKL_DefaultLocation', 'SpeechVoicePriority',
    'DISPID_SOTsItem', 'SREPropertyNumChange', 'SREPrivate',
    'SAFTNoAssignedFormat', 'SPGS_DISABLED', 'DISPID_SDKDeleteValue',
    'SREAllEvents', 'DISPID_SGRsDynamic', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SRRSpeakAudio', 'SpInProcRecoContext', 'SP_VISEME_2',
    'SPPHRASEREPLACEMENT', 'DISPID_SPEEngineConfidence',
    'SpeechAudioFormatType', 'SpeechGrammarTagUnlimitedDictation',
    'SAFTCCITT_uLaw_11kHzMono', 'SPXRO_Alternates_SML', 'SITooLoud',
    'DISPID_SVSkip', 'SpCompressedLexicon', 'DISPID_SPIProperties',
    'DISPID_SGRId', 'SVP_21', 'DISPID_SABufferInfo',
    'SAFT12kHz8BitStereo', 'SpMMAudioEnum',
    'SDA_Consume_Leading_Spaces', 'ISpeechAudioFormat', 'IStream',
    'SECNormalConfidence', 'ISpRecognizer3', 'SPVPRI_ALERT',
    'DISPID_SVVoice', 'DISPID_SMSALineId', 'DISPID_SRRSaveToMemory',
    'SpInprocRecognizer', 'eLEXTYPE_USER', 'SAFT24kHz16BitStereo',
    'SPGS_EXCLUSIVE', 'DISPID_SGRSTsCount', 'DISPID_SGRSTPropertyId',
    'ISpRecoContext2', '_ISpeechVoiceEvents', 'ISpDataKey',
    'SPEI_PHRASE_START', 'SPSHORTCUTPAIR', 'eLEXTYPE_PRIVATE16',
    'SRERequestUI', 'SPAS_RUN', 'SPEI_MIN_TTS', 'SVEWordBoundary',
    'SVSFUnusedFlags', 'SVP_16', 'eLEXTYPE_RESERVED4',
    ...
    'DISPID_SpeechPhraseBuilder', 'DISPID_SPRsItem', 'SVSFParseSapi',
    'ISpStream', 'SPAR_High', 'SBONone', 'eLEXTYPE_RESERVED7',
    'DISPID_SFSClose', 'SpeechAddRemoveWord', 'SPSERIALIZEDRESULT',
    'SpNullPhoneConverter', 'SGDisplay', 'STSF_CommonAppData',
    'SREStreamEnd', 'DISPID_SLWLangId', 'DISPID_SOTsCount', 'SVP_12',
    ...
    'SPPS_LMA', 'DISPID_SMSGetData', 'DISPID_SGRSTWeight',
    'DISPID_SGRSTNextState', 'SPPS_NotOverriden', 'SPEI_SOUND_START',
    'SDTProperty', 'SpeechPropertyAdaptationOn', 'DISPID_SAFType',
    'SVEAllEvents', 'DISPID_SVSLastBookmark', 'SVSFVoiceMask',
    'DISPID_SVEAudioLevel', 'DISPID_SRCEBookmark', 'SGRSTTRule',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SPWORDTYPE',
    'ISpResourceManager', 'SpeechCategoryAudioOut',
    'ISpeechObjectTokens', 'DISPID_SpeechRecoContext',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SGRSAddWordTransition',
    'ISpeechWaveFormatEx', 'ISpAudio', 'SpSharedRecoContext',
    'SPBO_AHEAD', 'DISPID_SpeechPhraseRules',
    '_ISpeechRecoContextEvents', 'DISPID_SGRSTPropertyValue',
    'DISPID_SPARecoResult', 'ISpProperties',
    ...
    'SpeechWordPronounceable', 'DISPID_SRGetPropertyNumber', 'SVP_14',
    'DISPID_SPERetainedSizeBytes', 'SPAO_NONE', 'DISPID_SAStatus',
    'SSFMOpenReadWrite', 'DISPID_SLGenerationId',
    'SpeechTokenKeyAttributes', 'DISPID_SLWPronunciations',
    'SRAExport', 'SRAORetainAudio', 'SPCS_ENABLED', 'IEnumString',
    'SPLEXICONTYPE', 'ISpPhoneticAlphabetConverter',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRCRequestedUIType',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SPRuleFirstElement',
    'DISPID_SABIBufferSize', 'SVP_4',
    'SpeechRegistryLocalMachineRoot', 'SpeechVisemeType',
    'SAFT16kHz8BitStereo', 'DISPID_SVGetVoices', 'SECFDefault',
    'SAFT44kHz8BitMono', 'DISPID_SPPChildren', 'SP_VISEME_20',
    'SPEI_WORD_BOUNDARY', 'DISPID_SOTCreateInstance',
    'DISPID_SpeechVoice', 'SWTAdded', 'DISPID_SOTCategory',
    'SPVPRI_OVER', 'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SOTId',
    'DISPID_SPPConfidence', 'SGDSInactive', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SPPValue', 'SpeechVoiceEvents', 'Speech_Max_Word_Length',
    'DISPID_SVResume', 'SSTTTextBuffer', 'SASPause', 'SLOStatic',
    'SPEI_VOICE_CHANGE', 'ISpeechPhraseAlternate',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SAFT8kHz8BitStereo',
    'DISPID_SRGIsPronounceable', 'SAFTNonStandardFormat',
    'SPAR_Medium', 'SRERecoOtherContext', 'SpeechFormatType',
    'DISPID_SRCEAdaptation', 'SRAImport', 'SVEVoiceChange',
    'SPAUDIOSTATE', 'SPWORD', 'DISPID_SPIGetDisplayAttributes',
    'WAVEFORMATEX', 'ISpPhrase', 'SVP_10', 'SPPS_Function',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SGRAddState',
    'eWORDTYPE_ADDED', 'DISPID_SRGSetWordSequenceData', 'SRARoot',
    'DISPID_SRCERequestUI', 'DISPID_SpeechGrammarRuleStateTransition',
    'SAFTADPCM_8kHzMono', 'SpeechRunState', 'SPWT_LEXICAL',
    'DISPID_SRRGetXMLResult', 'SPVOICESTATUS', 'DISPID_SAVolume',
    'DISPID_SPPParent', 'SpeechAllElements', 'SINoSignal',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SPAStartElementInResult', 'DISPID_SLPType',
    'STCLocalServer', 'SP_VISEME_13', 'SPCATEGORYTYPE',
    'DISPID_SRCEStartStream', 'DISPID_SVAudioOutputStream',
    'SPINTERFERENCE', 'SpeechGrammarState', 'SRSEDone',
    'DISPID_SPIStartTime', 'DISPID_SRRRecoContext',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SPIEnginePrivateData',
    'ISpeechPhraseInfo', 'SREPhraseStart', 'eLEXTYPE_PRIVATE2',
    'SPDKL_CurrentConfig', 'DISPID_SpeechXMLRecoResult',
    'SpeechCategoryAppLexicons', 'SPWAVEFORMATTYPE', 'SPCONTEXTSTATE',
    'DISPID_SOTCGetDataKey', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SVWaitUntilDone', 'SPBO_PAUSE',
    'DISPID_SpeechLexiconWord', 'SGRSTTWildcard', 'SP_VISEME_9',
    'SpeechLexiconType', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SpeechCategoryRecognizers', 'DISPID_SABufferNotifySize',
    'DISPID_SVSRunningState', 'SP_VISEME_3', 'DISPID_SPEs_NewEnum',
    'SpResourceManager', 'DISPID_SWFEFormatTag',
    'DISPID_SVSpeakStream', 'DISPID_SVGetProfiles',
    'SpeechInterference', 'SGRSTTTextBuffer', 'SREStateChange',
    'SPSMF_UPS', 'SAFT11kHz8BitMono', 'SAFTADPCM_11kHzStereo',
    'ISpRecoGrammar', 'ISpSerializeState', 'tagSPPROPERTYINFO',
    'DISPID_SOTSetId', 'SREStreamStart', 'SVEPrivate',
    'DISPID_SRGRules', 'ISpObjectTokenCategory', 'SPBOOKMARKOPTIONS',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPSSuppressWord',
    'DISPID_SRProfile', 'IInternetSecurityMgrSite', 'SPPS_Noun',
    'SSSPTRelativeToEnd', 'DISPID_SpeechPhraseInfo',
    'SpeechDisplayAttributes', 'SVF_Emphasis', 'SPAR_Unknown',
    'SPRULESTATE', 'eLEXTYPE_PRIVATE3',
    'DISPID_SpeechLexiconPronunciation', 'SAFT24kHz16BitMono',
    'DISPID_SASetState', 'SpMMAudioIn', 'DISPID_SOTGetDescription',
    'DISPID_SDKEnumKeys', 'DISPID_SRRTTickCount', 'DISPID_SPACommit',
    'SPPHRASE', 'DISPID_SPEAudioSizeBytes', 'ISpeechMemoryStream',
    'ISpRecognizer2', 'DISPID_SOTCDefault', 'SRSActiveAlways',
    'SRTReSent', 'SRSInactiveWithPurge', 'DISPID_SPILanguageId',
    'SITooSlow', 'SECFEmulateResult', 'eLEXTYPE_RESERVED10',
    'SpeechAudioFormatGUIDWave', 'DISPID_SDKSetLongValue',
    'SPFM_NUM_MODES', 'DISPID_SLPSymbolic', 'DISPID_SOTRemove',
    'SAFTADPCM_11kHzMono', 'SpWaveFormatEx', 'SPFM_OPEN_READWRITE',
